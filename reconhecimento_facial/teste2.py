...
# Carrega o arquivo jpg em um array numpy
    for file in files:
        image = face_recognition.load_image_file(f"C:/Users/Thiago/Desktop/Projeto_TCC/reconhecimento_facial/img/{file}")
        ...
        for face_location in face_locations:
            ...
            cv2.imwrite("C:/Users/Thiago/Documents/reconhecimento_facial/Face_Image.png", imageCinza)
            #pil_image.show() 
            #pega foto de cada rosto
            for file in files_rosto:
                image_rosto = reconhece_face(f"C:/Users/Thiago/Documents/reconhecimento_facial/SI7P13/{file}")
                ...
                image_desconhecido = reconhece_face("C:/Users/Thiago/Documents/reconhecimento_facial/Face_Image.png")
                #desconhecido = image
